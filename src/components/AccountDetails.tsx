    ...
    return (
        <div className="max-w-md mx-auto bg-white shadow-md rounded-md p-8 mt-8">
            ...
            <div className="mb-4">
                ...
                <input type="text" className="mt-1 p-2 border rounded-md w-full" placeholder="Dhanush" />
            </div>
            <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700">Last Name</label>
                <input type="text" className="mt-1 p-2 border rounded-md w-full" placeholder="Natarayadurai" />
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
                ...
                <input type="tel" className="mt-1 p-2 border rounded-md w-full" placeholder="Enter Your Mobile Number" />
            </div>
            <div className="mb-4">
